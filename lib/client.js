...
var ProviderVisibilityStore = class {
  constructor(directoryFor, unfilteredDirectory, currentSession) {
    this.directoryFor = directoryFor;
    this.unfilteredDirectory = unfilteredDirectory;
...
var inject = ["slots", "locale", "modelDirectories", "remote", "sessions", "settingsScope"];
